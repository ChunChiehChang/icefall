...
def get_args():
    ...
    parser.add_argument("--bpe-model", type=str, default='data/lang_bpe/bpe.model', help="bpe model for sentencepiece")

    return parser.parse_args()


def process_line(lexicon: Dict[str, List[str]], line: str, oov_token: str, sp: spm.SentencePieceProcessor) -> None:
    """
    Args:
      lexicon:
...
def main():
    ...
    with open(args.transcript) as f:
        for line in f:
            process_line(lexicon=lexicon, line=line, oov_token=oov_token, sp=sp)
